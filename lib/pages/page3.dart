                          ...
                          children: [
                           ...
                           (
                              ...
                              animation: DelayedAnimations.SLIDE_FROM_LEFT,
                               child: Container(
                                      child: const Image(
                                        ...
                                        height: 400,
                                        image:AssetImage (
                                            'assets/images/character_sol_visual@pc.png'),
                                      ),
                                    ),
                             ),
                           ),
                              ...
                              child: Align(
                                ...
                                child: Positioned(
                                  child: Container(
                                    ...
                                    height: 45.0,
                                    width: 180.0,
                                    color: Color.fromARGB(255, 249, 151, 23),
                                    child: const Align(
                            ...
                            FadeInRight(
                             ...
                             Align(
                              alignment: FractionalOffset(0.65, 1.4),
                              child: FadeInUp(
                                     duration: Duration(seconds: 1),
                                      child: Text(
                                "       An aggressive striker who beats \nthe the opponent down with style.",
                                style: TextStyle(shadows: <Shadow>[
                                  Shadow(
                                      offset: Offset(1.0, 1.0),
                                      blurRadius: 10.0,
                            ...
                            Align(
                              alignment: FractionalOffset(0.38 ,2.15),
                                child: FadeInUp(
                                duration: Duration(seconds: 1),
                                child:Text(
                                "           A blunt and short-tempered man. \nHe only speaks when required, and uses as few \nwords as he can get away with.\nHe's not very good at explaining things,\nso he prefersto express himself with \nhis aggressive behavior and attitude.",
                                style: TextStyle(shadows: <Shadow>[
                                  Shadow(
                                      offset: Offset(1.0, 1.0),
                                      blurRadius: 12.0,
